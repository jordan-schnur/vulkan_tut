...
unsafe fn create_render_pass(
    ...
    let color_attachment = vk::AttachmentDescription::builder()
        ...
        .initial_layout(vk::ImageLayout::UNDEFINED)
        .final_layout(vk::ImageLayout::COLOR_ATTACHMENT_OPTIMAL); // PRESENT_SRC_KHR Can not be presented directly. So we must add a color-resolve attachment
    ...
    let subpass = vk::SubpassDescription::builder()
        ...
        .resolve_attachments(resolve_attachments); // Can only have a single attachment
...
impl PartialEq for Vertex {
    fn eq(&self, other: &Self) -> bool {
        self.pos == other.pos && self.colour == other.colour && self.tex_coord == other.tex_coord
    }
}
